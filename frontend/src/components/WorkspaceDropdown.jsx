...
function WorkspaceDropdown() {
    ...
    return (
        <div className="relative mx-4 my-2" ref={dropdownRef}>
            <button onClick={() => setIsOpen(prev => !prev)} className="w-full flex items-center justify-between px-3 py-1.25 text-left rounded hover:bg-gray-100 dark:hover:bg-zinc-800" >
